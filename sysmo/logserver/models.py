...
class MachineGroup(models.Model):
    ...
    Gpolicy = models.ForeignKey("Policy",
                                blank=True,
                                null=True,
                                verbose_name=("群組策略"),
                                on_delete=models.SET_NULL)
...
class Policy(models.Model):
    ...
    swappolicy = models.JSONField(default=policy_default,
                                  verbose_name="SWAP策略")
...
class Performance(models.Model):
    ...
    machine = models.ForeignKey("Machine",
                                verbose_name=("主機"),
                                on_delete=models.CASCADE)
    cpu = models.DecimalField(verbose_name="CPU",
                              max_digits=5,
                              decimal_places=2)
    mem = models.DecimalField(verbose_name="MEM",
                              max_digits=5,
                              decimal_places=2)
    swap = models.DecimalField(verbose_name="SWAP",
                               max_digits=5,
                               decimal_places=2)
